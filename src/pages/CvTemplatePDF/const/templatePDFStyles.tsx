...
export const templatePDFStyles: StylesType = {
    ...
    sydney: {
        ...
        style: {
            ...
            SidebarPage: { flex: 2, minWidth: '30%',minHeight: '100%' , maxWidth: '40%', wordBreak: 'break-word' },
            MainPage: { backgroundColor: '#ffffff', color: 'black', flex: 3 , maxWidth: '60%' , wordBreak: 'break-word'},
    ...
    toronto: {
        ...
        style: {
            ...
            Socials: {
                ...
                padding: '2%',
                paddingLeft: '2%',
                marginBottom: '10px',pageBreakInside: 'avoid'
            },
            Social: {},
            SocialTitle: {
                fontFamily: 'Times-Bold',
